...
class BaseCrawler:
    ...
    def save_articles(self, articles_data):
        ...
        for data in articles_data:
            ...
            if any(k in t for k in ['考研','考公','公务员','行测','教育','招生','研究生','复试','考点']):
                cat = '考公考研'
            elif any(k in t for k in ['招聘','求职','面试','简历','职场','就业','实习','offer']):
                cat = '应届求职'
            elif any(k in t for k in ['股票','股市','大盘','涨停','跌停','上证','深证','创业板','科创板','恒生','A股','港股','美股','基金','ETF','牛市','熊市','涨幅','跌幅','成交额','板块','指数','开盘','收盘','投资','估值']):
                cat = '股票市场'
            article = NewsArticle(
                category=cat,
