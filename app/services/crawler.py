...
class BaseCrawler:
    ...
    def save_articles(self, articles_data):
        ...
        for data in articles_data:
            ...
            if any(k in t for k in ['考研','考公','公务员','行测','教育','招生','研究生','复试','考点','备考','录取','分数线','学位','学历','大学','高校','课程','教材','培训','考试网','国考','省考','申论','面试技巧','事业单位','教师招聘','教师资格']):
                cat = '考公考研'
            elif any(k in t for k in ['招聘','求职','面试','简历','职场','就业','实习','offer','校招','薪水','工资','待遇','跳槽','裁员','猎头','管培生','应届生','秋招','春招']):
                cat = '应届求职'
